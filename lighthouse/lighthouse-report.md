...
## Результаты после исправлений (.ru — задеплоено)

| Категория | Mobile (до) | Mobile (после) | Desktop (до) | Desktop (после) |
|---|---|---|---|---|
| **Performance** | 84 | **98 (+14)** | 59 | **95 (+36)** |
| **Accessibility** | 85 | **96 (+11)** | 85 | **94 (+9)** |
| **Best Practices** | 77 | **100 (+23)** | 77 | **100 (+23)** |
| **SEO** | 100 | 100 | 100 | 100 |

### Метрики после исправлений (.ru)

| Метрика | Mobile (до) | Mobile (после) | Desktop (до) | Desktop (после) |
|---|---|---|---|---|
| FCP | 2.1s | **1.6s (-24%)** | 0.7s | **0.6s** |
| LCP | 3.0s | **1.8s (-40%)** | 2.3s | **1.2s (-48%)** |
| TBT | 280ms | **80ms (-71%)** | 690ms | **120ms (-83%)** |
| CLS | 0.024 | 0.024 | 0.003 | 0.003 |
| Speed Index | 4.8s | **2.4s (-50%)** | 2.0s | **1.0s (-50%)** |
| TTI | 12.8s | **3.0s (-77%)** | 2.7s | **1.2s (-56%)** |

> .ru показал отличные результаты на обоих форматах. Desktop Performance вырос с 59 до 95 (+36), Mobile с 84 до 98. TBT снижен на 71-83%, LCP на 40-48%, TTI на 56-77%.
